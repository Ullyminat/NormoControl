...
<h1 align="center">NormoControl</h1>
...
**Для Студентов**
- **Премиальный Интерфейс (Swiss Design + Apple Vision Style)**: Интерактивный UI с 3D-параллаксом стеклянных карточек (Glassmorphism), магнитной физикой кнопок и идеальной плавностью (60+ FPS благодаря GSAP).
