# NormoControl - Система Проверки Академических Документов
...
- **Библиотеки Go**: Gin, GORM, golang.org/x/crypto
- **Экосистема React**: Vite, Zustand, React Router, Axios
- **Рендеринг PDF**: Mozilla PDF.js
- **Парсинг Документов**: Спецификации Office Open XML SDK

---

**Поддержка**: Команда Академических Решений  
**Контакт**: support@normocontrol.dev  
**Документация**: [docs.normocontrol.dev](https://docs.normocontrol.dev)
